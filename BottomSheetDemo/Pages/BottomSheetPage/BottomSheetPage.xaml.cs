...
namespace BottomSheetDemo.Pages.BottomSheetPage
{
    ...
    {
        private double BOTTOM_SHEET_OPEN_RATIO = -2.65; // you'll need to play with this value to get the right height or look into making it dynamic based on content height
        private double BOTTOM_SHEET_OPEN_EXTENDED_RATIO = -1.65;
